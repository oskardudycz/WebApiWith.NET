...
namespace Logging.Default.Controllers
{
    ...
    public class ReservationsController : Controller
    {
        ...
        public IActionResult Create([FromBody] CreateReservation request)
        {
            ...
            {
                logger.LogWarning("Invalid {SeatId}", request?.SeatId);
            ...
            {
                logger.LogWarning("Seat with {SeatId} is already reserved", reservation.SeatId);
        ...
        public IActionResult Update([FromBody] UpdateReservation request)
        {
            ...
            {
                logger.LogWarning("Invalid {ReservationId}", request?.ReservationId);
